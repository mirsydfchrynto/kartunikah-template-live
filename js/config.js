 ...
 *    - Personal: Buka link dengan parameter ?to=Nama+Tamu (contoh: ?to=Bapak+Joko)
 *      maka nama tamu otomatis tertulis rapi di kartu undangan dan RSVP!
 * 2. GANTI FOTO:
...
const CONFIG = {
  ...
  theme: {
    ...
    envelopeColor:'#8B4513',   // Warna kertas warkat / aksen coklat
  ...
  // ════════════════════════════════════════════════════════════════════════
  // 10. ALBUM FOTO KISAH SINEMATIK (Galeri Berjalan & FancyBox)
  // ════════════════════════════════════════════════════════════════════════
  gallery: [
    {
  ...
  // ════════════════════════════════════════════════════════════════════════
  // 13. PENGATURAN WHATSAPP & TAUTAN UNDANGAN TAMU
  // ════════════════════════════════════════════════════════════════════════
  whatsapp: {
  ...
  mockMessages: [
    ...
    { name: 'Pak Hendra Wijaya',     message: 'Alhamdulillah, akhirnya terlaksana hari bahagia ini! Selamat untuk Rizky dan Sinta. Semoga senantiasa diberkahi kebahagiaan.', likes: 8 },
    ...
    { name: 'Tim Arsitek Nusantara', message: 'Selamat berbahagia Mas Rizky dan Mbak Sinta! Semoga pernikahan ini membawa berkah yang melimpah.', likes: 20 },
  ],
};
